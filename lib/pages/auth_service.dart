...
class AuthService {
  static Future<void> registerUser(
    ...
    final Uri registerUri = Uri.parse('http://192.168.1.9:8000/api/patient/register');
  ...
  static Future<void> signInUser(BuildContext context, TextEditingController emailController, TextEditingController passwordController) async {
    final Uri loginUri = Uri.parse('http://192.168.1.9:8000/api/patient/login');
    final Map<String, dynamic> userData = {
      'email': emailController.text,
      'password': passwordController.text,
    };
    ...
    try {
      ...
      if (loginResponse.statusCode == 200) {
        ...
        final Uri profileUri = Uri.parse('http://192.168.1.9:8000/api/patient/profile');
  ...
  static Future<void> logout(BuildContext context) async {
    ...
    try {
      ...
      // Make logout request
      final Uri logoutUri = Uri.parse('http://192.168.1.9:8000/api/patient/logout');
